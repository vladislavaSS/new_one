...
module axil_fifo #(
    ...
    //before /*parameter   string    MEM_STYLE [5] = '{"Distributed", "Distributed", "Distributed", "Distributed", "Distributed"},  */
  ...
  fifo #(
    ...
    .DEPTH ( DEPTH[0] ),
    .FWFT ( "True" ),
//    .MEM_STYLE ( MEM_STYLE[0] ),  //before
    .MEM_STYLE ( WA_MEM_STYLE ),    //after
